...
export default function Hero() {
  ...
  return (
    <section className="w-full lg:h-[calc(100vh-70px)] lg:h-[calc(100vh-70px)] min-h-full relative flex flex-col lg:flex-row">
          ...
          <div className="flex flex-col lg:items-start lg:justify-center lg:flex-1 mb-[1rem] md:mb-[1.75rem]">
            ...
            <div
              className="
                ...
                "
            >
              <span className="text-[1rem] sm:text-[1.2rem] text-gray-800 pb-3">[{t('smallTitle')}]</span>
              <span
                className="
              ...
              >
                ...
                <a
                  ...
                  className="
                    ...
                    "
                >
                  <FontAwesomeIcon icon={faYandex} className="text-[1rem]" />
                </a>
              </div>
            </div>
          </div>
